/**
 * Auto-generated from QA Mode B draft MS-104855
 * Source title: 用户管理-用户列表-更新用户：更新用户名称、用户名、邮箱信息
...
const MS_ID = 'MS-104855'
const TITLE = `用户管理-用户列表-更新用户：更新用户名称、用户名、邮箱信息`
const STEPS = [
  {
    "action": "用户管理-用户列表-更新用户：更新用户名称、用户名、邮箱信息，提交",
    "id": "step-1",
    "sideEffect": "reversible"
  }
]
const OUTCOMES = [
  "[1] 更改成功，查看该用户信息，是更改后的信息。使用新修改的用户名登录，正确的密码登录成功。"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户列表；验证: 用户管理-用户列表-更新用户：更新用户名称、用户名、邮箱信息`
