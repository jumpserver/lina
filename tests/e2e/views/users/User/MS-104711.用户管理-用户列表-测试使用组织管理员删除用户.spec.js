/**
 * Auto-generated from QA Mode B draft MS-104711
 * Source title: 用户管理-用户列表：测试使用组织管理员删除用户
...
const MS_ID = 'MS-104711'
const TITLE = `用户管理-用户列表：测试使用组织管理员删除用户`
const STEPS = [
  {
    "action": "用户管理-用户列表：测试使用组织管理员删除系统管理员",
    "id": "step-1",
    "sideEffect": "destructive"
  },
  {
    "action": "用户管理-用户列表：测试使用组织管理员删除系统审计员",
    "id": "step-2",
    "sideEffect": "destructive"
  },
  {
    "action": "用户管理-用户列表：测试使用组织管理员删除普通用户",
    "id": "step-3",
    "sideEffect": "destructive"
  }
]
...
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户列表；验证: 用户管理-用户列表：测试使用组织管理员删除用户`
