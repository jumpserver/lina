/**
 * Auto-generated from QA Mode B draft MS-104472
 * Source title: 用户管理-用户列表：组织管理测试批量操作用户
...
const MS_ID = 'MS-104472'
const TITLE = `用户管理-用户列表：组织管理测试批量操作用户`
const STEPS = [
  {
    "action": "测试组织管理员批量删除用户",
    "id": "step-1",
    "sideEffect": "destructive"
  },
  {
    "action": "测试组织管理员批量禁用用户",
    "id": "step-2",
    "sideEffect": "reversible"
  },
  {
    "action": "测试组织管理员批量激活用户",
    "id": "step-3",
    "sideEffect": "reversible"
  },
  {
    "action": "测试组织管理员批量更新用户",
    "id": "step-4",
    "sideEffect": "reversible"
  },
  {
    "action": "测试组织管理员批量移除用户",
    "id": "step-5",
    "sideEffect": "destructive"
  }
]
...
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户列表；验证: 用户管理-用户列表：组织管理测试批量操作用户`
