/**
 * Auto-generated from QA Mode B draft MS-104694
 * Source title: 用户管理-用户列表：测试克隆用户
...
const MS_ID = 'MS-104694'
const TITLE = `用户管理-用户列表：测试克隆用户`
const STEPS = [
  {
    "action": "用户管理-用户列表：选择一个用户，点击克隆",
    "id": "step-1",
...
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户列表；验证: 用户管理-用户列表：测试克隆用户`
