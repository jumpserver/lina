/**
 * Auto-generated from QA Mode B draft MS-102480
 * Source title: 用户管理-用户列表-创建用户：测试重复名称、用户名、邮箱
...
const MS_ID = 'MS-102480'
const TITLE = `用户管理-用户列表-创建用户：测试重复名称、用户名、邮箱`
const STEPS = [
  {
    "action": "用户管理-用户列表-创建用户：测试重复名称、用户名、邮箱",
    "id": "step-1",
    "sideEffect": "reversible"
  }
]
const OUTCOMES = [
  "[1] 创建失败，提示该名称、用户名、邮箱已重复"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户列表；验证: 用户管理-用户列表-创建用户：测试重复名称、用户名、邮箱`
