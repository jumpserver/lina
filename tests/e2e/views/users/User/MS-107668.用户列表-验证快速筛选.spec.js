/**
 * Auto-generated from QA Mode B draft MS-107668
 * Source title: 用户列表：验证快速筛选
...
const MS_ID = 'MS-107668'
const TITLE = `用户列表：验证快速筛选`
const STEPS = [
  {
    "action": "用户列表：快速筛选，点击无效的：筛选无效的用户",
    "id": "step-1",
    "sideEffect": "none"
  },
  {
    "action": "用户列表：快速筛选，点击禁用的：筛选禁用的用户",
    "id": "step-2",
    "sideEffect": "reversible"
  },
  {
    "action": "用户列表：快速筛选，点击过期的：筛选已过期的用户",
    "id": "step-3",
    "sideEffect": "none"
  },
  {
    "action": "用户列表：快速筛选，点击从未登录的：筛选从未登录的用户",
    "id": "step-4",
    "sideEffect": "none"
  }
]
const OUTCOMES = [
  "[1] 页面显示无效的用户，包含禁用的，过期的用户",
  "[2] 页面显示已禁用的用户（未激活的用户）",
  "[3] 页面显示已过期的用户",
  "[4] 页面显示从未登录的用户"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户列表；验证: 用户列表：验证快速筛选`
