/**
 * Auto-generated from QA Mode B draft MS-100606
 * Source title: 更新用户表单优化为抽屉式表单（右侧弹出）
...
const MS_ID = 'MS-100606'
const TITLE = `更新用户表单优化为抽屉式表单（右侧弹出）`
const STEPS = [
  {
    "action": "用户管理，点击更新用户",
    "id": "step-1",
...
const OUTCOMES = [
  ...
  "[2] 更新用户成功。显示用户列表，可查看到该用户的信息是更新后的信息。",
  "[3] 更新用户成功。显示用户列表，可查看到该用户的用户组信息是更新后信息",
  "[4] 更新用户成功。显示用户列表，可查看到该用户的信息是正确的。使用该用户登录，提示要绑定MFA",
  "[5] 更新用户成功。使用该用户登录，使用新密码登录，登录成功",
  "[6] 更新用户成功。使用该用户登录，使用新的密钥登录，登录成功. ssh username@IP -p2222 -i ./新密钥文件  免密登录成功",
  "[7] 更新用户成功。显示用户列表，可查看到该用户的信息是正确的。用户登录，拥有所选角色的权限",
  "[8] 更新用户成功。显示用户列表，可查看到该用户的信息是正确的。且用户的有效字段是打岔的，且使用该用户登录失败。"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户列表；验证: 更新用户表单优化为抽屉式表单（右侧弹出）`
