/**
 * Auto-generated from QA Mode B draft MS-104754
 * Source title: 用户管理-用户列表：测试使用系统管理员删除用户
...
const MS_ID = 'MS-104754'
const TITLE = `用户管理-用户列表：测试使用系统管理员删除用户`
const STEPS = [
  {
    "action": "用户管理-用户列表：测试使用系统管理员删除系统管理员",
    "id": "step-1",
    "sideEffect": "destructive"
  },
  {
    "action": "用户管理-用户列表：测试使用系统管理员删除系统审计员",
    "id": "step-2",
    "sideEffect": "destructive"
  },
  {
    "action": "用户管理-用户列表：测试使用系统管理员删除普通用户",
    "id": "step-3",
    "sideEffect": "destructive"
  }
]
const OUTCOMES = [
  "[1] 删除成功，查看用户列表，该用户已不在用户列表中。全局组织下，也搜索不到该用户",
  "[2] 删除成功，查看用户列表，该用户已不在用户列表中。全局组织下，也搜索不到该用户",
  "[3] 删除成功，查看用户列表，该用户已不在用户列表中。全局组织下，也搜索不到该用户"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户列表；验证: 用户管理-用户列表：测试使用系统管理员删除用户`
