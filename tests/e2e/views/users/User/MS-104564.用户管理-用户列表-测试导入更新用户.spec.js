/**
 * Auto-generated from QA Mode B draft MS-104564
 * Source title: 用户管理-用户列表：测试导入更新用户
...
const MS_ID = 'MS-104564'
const TITLE = `用户管理-用户列表：测试导入更新用户`
const STEPS = [
  {
    "action": "用户管理-用户列表：使用系统管理员测试导入更新用户",
    "id": "step-1",
    "sideEffect": "reversible"
  },
  {
    "action": "用户管理-用户列表：使用组织管理员测试导入更新用户",
    "id": "step-2",
    "sideEffect": "reversible"
  }
]
...
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户列表；验证: 用户管理-用户列表：测试导入更新用户`
