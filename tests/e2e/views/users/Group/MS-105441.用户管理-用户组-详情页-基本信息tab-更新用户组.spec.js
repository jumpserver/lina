/**
 * Auto-generated from QA Mode B draft MS-105441
 * Source title: 用户管理-用户组-详情页-基本信息tab：更新用户组
...
const MS_ID = 'MS-105441'
const TITLE = `用户管理-用户组-详情页-基本信息tab：更新用户组`
const STEPS = [
  {
    "action": "用户管理-用户组-详情页-基本信息tab：更新用户组，如更新名称、添加用户等信息，提交",
    "id": "step-1",
    "sideEffect": "reversible"
  }
]
const OUTCOMES = [
  "[1] 更新成功，查看用户组信息，是更新后的信息"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 用户管理-用户组-详情页-基本信息tab：更新用户组`
