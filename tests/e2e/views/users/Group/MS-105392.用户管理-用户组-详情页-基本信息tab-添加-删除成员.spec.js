/**
 * Auto-generated from QA Mode B draft MS-105392
 * Source title: 用户管理-用户组-详情页-基本信息tab：添加/删除成员
...
const MS_ID = 'MS-105392'
const TITLE = `用户管理-用户组-详情页-基本信息tab：添加/删除成员`
const STEPS = [
  {
    "action": "用户管理-用户组-详情页-基本信息tab：添加成员",
    "id": "step-1",
    "sideEffect": "reversible"
  },
  {
    "action": "用户管理-用户组-详情页-基本信息tab：删除成员",
    "id": "step-2",
    "sideEffect": "destructive"
  }
]
const OUTCOMES = [
  "[1] 提示添加成功，查看用户列表，这些用户的用户组字段显示正确",
  "[2] 提示删除成功，查看用户列表，这些用户的用户组字段已没有该用户组名称"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 用户管理-用户组-详情页-基本信息tab：添加/删除成员`
