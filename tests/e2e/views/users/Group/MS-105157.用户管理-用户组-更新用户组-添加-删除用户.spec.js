/**
 * Auto-generated from QA Mode B draft MS-105157
 * Source title: 用户管理-用户组-更新用户组：添加/删除用户
...
const MS_ID = 'MS-105157'
const TITLE = `用户管理-用户组-更新用户组：添加/删除用户`
const STEPS = [
  {
    "action": "用户管理-用户组-更新用户组：添加用户",
    "id": "step-1",
    "sideEffect": "reversible"
  }
]
const OUTCOMES = [
  "[1] 更新成功，查看用户列表，这些用户属于该用户组"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 用户管理-用户组-更新用户组：添加/删除用户`
