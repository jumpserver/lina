/**
 * Auto-generated from QA Mode B draft MS-105699
 * Source title: 用户管理-用户组：测试删除用户组
...
const MS_ID = 'MS-105699'
const TITLE = `用户管理-用户组：测试删除用户组`
const STEPS = [
  {
    "action": "用户管理-用户组：测试删除用户组",
    "id": "step-1",
    "sideEffect": "destructive"
  }
]
const OUTCOMES = [
  "[1] 删除成功，查看用户组列表，该用户组已不在用户组列表中"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 用户管理-用户组：测试删除用户组`
