/**
 * Auto-generated from QA Mode B draft MS-105288
 * Source title: 用户管理-用户组-更新用户组：必填项不填写
...
const MS_ID = 'MS-105288'
const TITLE = `用户管理-用户组-更新用户组：必填项不填写`
const STEPS = [
  {
    "action": "用户管理-用户组-更新用户组：必填项不填写",
    "id": "step-1",
...
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 用户管理-用户组-更新用户组：必填项不填写`
