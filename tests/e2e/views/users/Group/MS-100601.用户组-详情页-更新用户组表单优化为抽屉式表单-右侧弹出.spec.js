/**
 * Auto-generated from QA Mode B draft MS-100601
 * Source title: 用户组-详情页：更新用户组表单优化为抽屉式表单（右侧弹出）
...
const MS_ID = 'MS-100601'
const TITLE = `用户组-详情页：更新用户组表单优化为抽屉式表单（右侧弹出）`
const STEPS = [
  {
    "action": "用户管理-用户组-详情页：点击更新用户组",
    "id": "step-1",
...
const OUTCOMES = [
  ...
  "[2] 更新成功过。该详情页自动刷新，查看该用户组信息是更新后信息正确的。"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 用户组-详情页：更新用户组表单优化为抽屉式表单（右侧弹出）`
