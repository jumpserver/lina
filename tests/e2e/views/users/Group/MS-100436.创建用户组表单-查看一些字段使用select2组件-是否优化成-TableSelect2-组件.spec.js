/**
 * Auto-generated from QA Mode B draft MS-100436
 * Source title: 创建用户组表单-查看一些字段使用select2组件，是否优化成 TableSelect2 组件
...
const MS_ID = 'MS-100436'
const TITLE = `创建用户组表单-查看一些字段使用select2组件，是否优化成 TableSelect2 组件`
const STEPS = [
  {
    "action": "创建用户组表单-添加用户的select2组件，是否优化成 TableSelect2组件",
    "id": "step-1",
...
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 创建用户组表单-查看一些字段使用select2组件，是否优化成 TableSelect2 组件`
