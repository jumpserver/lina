/**
 * Auto-generated from QA Mode B draft MS-105970
 * Source title: 用户管理-用户组：测试导入更新用户组
...
const MS_ID = 'MS-105970'
const TITLE = `用户管理-用户组：测试导入更新用户组`
const STEPS = [
  {
    "action": "用户管理-用户组：测试导入更新用户组，Excel格式",
    "id": "step-1",
    "sideEffect": "reversible"
  },
  {
    "action": "用户管理-用户组：测试导入更新用户组，csv格式",
    "id": "step-2",
    "sideEffect": "reversible"
  }
]
...
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 用户管理-用户组：测试导入更新用户组`
