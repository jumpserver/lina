/**
 * Auto-generated from QA Mode B draft MS-105807
 * Source title: 用户管理-用户组：测试自定义显示表单字段
...
const MS_ID = 'MS-105807'
const TITLE = `用户管理-用户组：测试自定义显示表单字段`
const STEPS = [
  {
    "action": "用户管理-用户组：测试自定义显示列表字段，勾选需要显示的字段，提交",
    "id": "step-1",
    "sideEffect": "reversible"
  }
]
const OUTCOMES = [
  "[1] 返回用户组，用户列表只显示自定义表单字段"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 用户管理-用户组：测试自定义显示表单字段`
