/**
 * Auto-generated from QA Mode B draft MS-105109
 * Source title: 用户管理-用户组-创建用户组：名称重复
...
const MS_ID = 'MS-105109'
const TITLE = `用户管理-用户组-创建用户组：名称重复`
const STEPS = [
  {
    "action": "用户管理-用户组-创建用户组：名称重复",
    "id": "step-1",
...
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 用户管理-用户组-创建用户组：名称重复`
