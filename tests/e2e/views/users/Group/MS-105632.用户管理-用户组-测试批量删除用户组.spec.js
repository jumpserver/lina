/**
 * Auto-generated from QA Mode B draft MS-105632
 * Source title: 用户管理-用户组：测试批量删除用户组
...
const MS_ID = 'MS-105632'
const TITLE = `用户管理-用户组：测试批量删除用户组`
const STEPS = [
  {
    "action": "用户管理-用户组：测试批量删除用户组",
    "id": "step-1",
    "sideEffect": "destructive"
  }
]
const OUTCOMES = [
  "[1] 删除成功，这些被删除的用户组已不在用户组列表了"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户组；验证: 用户管理-用户组：测试批量删除用户组`
