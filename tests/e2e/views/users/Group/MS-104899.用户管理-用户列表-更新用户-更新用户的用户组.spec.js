/**
 * Auto-generated from QA Mode B draft MS-104899
 * Source title: 用户管理-用户列表-更新用户：更新用户的用户组
...
const MS_ID = 'MS-104899'
const TITLE = `用户管理-用户列表-更新用户：更新用户的用户组`
const STEPS = [
  {
    "action": "用户管理-用户列表-更新用户：更新用户的用户组，提交",
    "id": "step-1",
    "sideEffect": "reversible"
  }
]
const OUTCOMES = [
  "[1] 更新成功，查看用户列表，该用户的用户字段显示的更新后的用户组信息"
]
const BEHAVIOR = `模块: JumpServer / 控制台 / 用户管理 / 用户列表；验证: 用户管理-用户列表-更新用户：更新用户的用户组`
