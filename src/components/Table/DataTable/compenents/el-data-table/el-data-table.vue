        ...
        >
          <template v-if="isTree">
            ...
            >
              <template #default="scope">
                ...
                >
                  <el-icon
                    ><component :is="scope.row._expanded ? 'Minus' : 'Plus'"
                  /></el-icon>
                </span>
          ...
          <template v-else>
            ...
            <el-table-column
              ...
              :key="col.prop"
              :filter-method="
                typeof col.filterMethod === 'function' ? col.filterMethod : null
              "
              :filter-multiple="false"
              :filters="col.filters || null"
              :formatter="
                typeof col.formatter === 'function' ? col.formatter : null
              "
              :title="col.label"
              :prop="col.prop"
            >
...
export default {
  ...
  methods: {
    ...
    getListFromStaticData({ loading = true } = {}) {
      ...
      this.$log.debug(
        `page: ${page}, size: ${this.size}, start: ${start}, end: ${end}`,
      );
