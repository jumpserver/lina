<template>
  <div>
    <TableAction :table-url="tableConfig.url" :tag-search="tableConfig.tagSearch" :search-table="search" v-bind="headerActions" :selected-rows="selectedRows" :reload-table="reloadTable" />
