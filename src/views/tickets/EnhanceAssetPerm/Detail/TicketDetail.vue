    ...
    detailCardItems() {
      return [
        ...
        },
        {
          ...
          value: this.object.assignees_display.toString()
        },
        {
      ...
      return [
        {
          ...
          value: this.object.meta.enchance_host_display.toString()
        },
        {
      ...
      return [
        {
          ...
          value: this.object.meta.approve_asset_display
        },
        {
          key: this.$t('tickets.SystemUser'),
      ...
      if (this.requestForm.asset.length === 0 || this.requestForm.systemuser.length === 0) {
        ...
        this.$axios.put(`/api/v1/tickets/tickets/${this.object.id}/approve/`, {
          meta: {
            ...
            approve_asset: this.requestForm.asset,
