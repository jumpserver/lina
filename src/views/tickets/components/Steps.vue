    ...
    <div style="height: 660px;">
      <el-steps direction="vertical" :active="ticketSteps">
        ...
        >
          ...
          <div v-if="item.state!=='notified'" slot="description" style="color: blue">
        ...
        >
          <div v-if="this.object.status==='closed'" slot="description">
...
export default {
  ...
  data() {
    return {
      countAll: this.object.process_map.length + 2,
  ...
  computed: {
    ticketSteps() {
      ...
      } else if (this.object.process_map.length === 1) {
        return this.STATUS.open
      } else {
        this.object.process_map.forEach(i => {
          if (i.state !== 'notified') {
