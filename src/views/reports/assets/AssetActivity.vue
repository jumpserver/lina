...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      this.user_asset_activity_metrics.dates_metrics_date = data.user_asset_activity_metrics?.dates_metrics_date || []
      this.user_asset_activity_metrics.dates_metrics_total_count_active_users = data.user_asset_activity_metrics?.dates_metrics_total_count_active_users || []
      this.user_asset_activity_metrics.dates_metrics_total_count_active_assets = data.user_asset_activity_metrics?.dates_metrics_total_count_active_assets || []
