    ...
    return {
      ...
      quickActions: [{
        ...
        callbacks: Object.freeze({
          change: val => {
            this.$axios.patch(`/api/v1/accounts/accounts/${this.object.id}/`, {
              is_active: val,
        ...
        attrs: {
          type: 'primary',
          label: this.$t('Test'),
          disabled: !vm.$hasPerm('accounts.verify_account') || !vm.object.asset.auto_config?.ansible_enabled || !vm.object.asset.auto_config?.ping_enabled || this.$store.getters.currentOrgIsRoot
        },
        callbacks: Object.freeze({
          click: () => {
        ...
        attrs: {
          type: 'primary',
          label: this.$t('Push'),
          disabled: !vm.$hasPerm('accounts.push_account') || !vm.object.asset.auto_config?.push_account_enabled || this.$store.getters.currentOrgIsRoot
        },
        callbacks: Object.freeze({
          click: () => {
