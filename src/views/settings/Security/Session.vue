        ...
        fieldsMeta: {
          ...
          SECURITY_WATERMARK_COLOR: {
            ...
            el: {
              size: 'small',
              'show-alpha': true,
              predefine: ['rgba(128, 128, 128, 0.25)', 'rgba(0, 0, 0, 0.15)', 'rgba(255, 255, 255, 0.2)', 'rgba(176, 176, 176, 0.3)', 'rgba(91, 155, 213, 0.25)', 'rgba(192, 80, 77, 0.2)', 'rgba(112, 173, 71, 0.2)', 'rgba(255, 192, 0, 0.18)']
            }
          }
        },
