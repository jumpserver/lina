...
export const ACCOUNT_PROVIDER_ATTRS_MAP = {
  [aliyun]: {
    ...
    image: getAssetUrl('img/cloud/ali.svg')
  },
  [aws_international]: {
    name: aws_international,
    title: i18n.t('AWS_Int'),
    attrs: ['access_key_id', 'access_key_secret'],
    image: getAssetUrl('img/cloud/aws_international.svg')
  },
  [aws_china]: {
    name: aws_china,
    title: i18n.t('AWS_China'),
    attrs: ['access_key_id', 'access_key_secret'],
    image: getAssetUrl('img/cloud/aws_china.svg')
  },
  [huaweicloud]: {
    name: huaweicloud,
  ...
  [baiducloud]: {
    ...
    attrs: ['access_key_id', 'access_key_secret'],
    image: getAssetUrl('img/cloud/baidu.svg')
  },
  [jdcloud]: {
    name: jdcloud,
    title: i18n.t('JDCloud'),
    attrs: ['access_key_id', 'access_key_secret'],
    image: getAssetUrl('img/cloud/jd.svg')
  },
  [kingsoftcloud]: {
    name: kingsoftcloud,
    title: i18n.t('KingSoftCloud'),
    attrs: ['access_key_id', 'access_key_secret'],
    image: getAssetUrl('img/cloud/kingsoft.svg')
  },
  [qcloud]: {
    name: qcloud,
    title: i18n.t('Qcloud'),
    attrs: ['access_key_id', 'access_key_secret'],
    image: getAssetUrl('img/cloud/qcloud.svg')
  },
  [qcloud_lighthouse]: {
    name: qcloud_lighthouse,
    title: i18n.t('QcloudLighthouse'),
    attrs: ['access_key_id', 'access_key_secret'],
    image: getAssetUrl('img/cloud/qcloud_lighthouse.svg')
  },
  [azure]: {
    name: azure,
    title: i18n.t('Azure'),
    attrs: ['client_id', 'client_secret', 'tenant_id', 'subscription_id'],
    image: getAssetUrl('img/cloud/azure_china.svg')
  },
  [azure_international]: {
    name: azure_international,
    title: i18n.t('Azure_Int'),
    attrs: ['client_id', 'client_secret', 'tenant_id', 'subscription_id'],
    image: getAssetUrl('img/cloud/azure_international.svg')
  },
  [gcp]: {
    name: gcp,
    title: i18n.t('GCP'),
    attrs: ['service_account_key'],
    image: getAssetUrl('img/cloud/gcp.svg')
  },
  [ucloud]: {
    name: ucloud,
    title: i18n.t('UCloud'),
    attrs: ['base_url', 'public_key', 'private_key', 'project'],
    image: getAssetUrl('img/cloud/ucloud.svg')
  },
  [volcengine]: {
    name: volcengine,
  ...
  [vmware]: {
    ...
    image: getAssetUrl('img/cloud/vmware.svg')
  },
  [nutanix]: {
    name: nutanix,
    title: 'Nutanix',
    attrs: ['access_key_id', 'access_key_secret', 'api_endpoint'],
    image: getAssetUrl('img/cloud/nutanix.svg')
  },
  [qingcloud_private]: {
    name: qingcloud_private,
    title: i18n.t('QingYunPrivateCloud'),
    attrs: ['access_key_id', 'access_key_secret', 'api_endpoint'],
    image: getAssetUrl('img/cloud/qing.svg')
  },
  [huaweicloud_private]: {
  ...
  [openstack]: {
    ...
    image: getAssetUrl('img/cloud/openstack.svg')
  },
  [zstack]: {
    name: zstack,
    title: i18n.t('ZStack'),
    attrs: ['access_key_id', 'access_key_secret', 'api_endpoint'],
    image: getAssetUrl('img/cloud/zstack.svg')
  },
  [smartx]: {
    name: smartx,
    title: i18n.t('SmartX CloudTower'),
    attrs: ['username', 'password', 'api_endpoint'],
    image: getAssetUrl('img/cloud/smartx.svg')
  },
  [fc]: {
    name: fc,
    title: i18n.t('FC'),
  ...
  [scp]: {
    ...
    title: i18n.t('SCP'),
    attrs: ['access_key_id', 'access_key_secret', 'api_endpoint'],
    image: getAssetUrl('img/cloud/scp.svg')
  },
  [apsara_stack]: {
    name: apsara_stack,
  ...
  [proxmox]: {
    ...
    attrs: ['username', 'password', 'api_endpoint'],
    image: getAssetUrl('img/cloud/proxmox.svg')
  },
  [lan]: {
    name: lan,
    title: i18n.t('LAN'),
    attrs: ['ip_group', 'test_port', 'test_timeout', 'hostname_prefix'],
    image: getAssetUrl('img/cloud/lan.svg'),
    imageCSS: {}
  }
}
