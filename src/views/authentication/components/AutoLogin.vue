<template>
  <div>
    <el-checkbox v-model="auto_login" style="color: #737373">
      {{ auto_login_days }} 天内自动登录
    </el-checkbox>
    <el-link type="primary" :underline="false" :href="forgot_password_url" style="float: right;">
      {{ this.$t('route.ForgetPassword') }}
    </el-link>
  </div>
</template>
